...
<p align="center">
  ...
  <a href="CHANGELOG.md"><img src="https://img.shields.io/badge/version-0.25.0-A855F7?style=flat-square" alt="0.25.0"></a>
...
export CLIQUE_HOME="$HOME/.clique"   # where the password and session secret live
...
A block in [`config/clis.toml`](config/clis.toml). Reload the page. No restart, no code:
