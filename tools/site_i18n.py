...
CLONE = "pip install clique-panel\nclique password\nclique"
CSS_V = "11"
...
PAGES = {
    "en": dict(
        ...
        self_b="Self-host",
        self="Free forever. MIT. Install it, it runs on your box, it binds loopback.",
    ...
    "zh": dict(
        ...
        self_b="自托管",
        self="永远免费。MIT。安装即用，跑在你的机器上，只绑回环地址。",
        paid_b="不想自托管",
    ...
    "ja": dict(
        ...
        self_b="セルフホスト",
        self="永久無料。MIT。インストールして、自分のマシンで動かす。ループバックにだけバインドします。",
        paid_b="セルフホストしたくない",
    ...
    "ko": dict(
        ...
        self_b="셀프호스트",
        self="영원히 무료. MIT. 설치해서 당신 머신에서 돌립니다. 루프백에만 바인드합니다.",
        paid_b="셀프호스트하기 싫다면",
    ...
    "pt-br": dict(
        ...
        self_b="Self-host",
        self="Grátis para sempre. MIT. Instale, rode na sua máquina, só escuta em loopback.",
    ...
    "de": dict(
        ...
        self_b="Self-Host",
        self="Für immer kostenlos. MIT. Installieren, auf deiner Box laufen lassen, nur Loopback.",
